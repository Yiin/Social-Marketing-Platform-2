<template>
    <div>
        ...
        <table v-else class="table">
            ...
            <tbody>
            <tr is="facebook-account-row" v-for="(account, index) in accounts" :account="account" :onDelete="onDelete" :index="index"></tr>
            <tr>
                <td></td>
                <td></td>
                <td></td>
    ...
    export default {
        ...
        methods: {
            create() {
                ...
                this.$http.post(Laravel.routes['facebook-account.store'], this.account).then(response => {
