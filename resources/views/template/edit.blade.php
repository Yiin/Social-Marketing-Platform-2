...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    <h4 class="title">Update Post Template</h4>
                </div>
                <div class="content">
                    <form action="{{ route('template.update', ['template' => $template->id]) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('description') ? 'has-error has-feedback' : '' }}">
                                    ...
                                    <textarea class="form-control" placeholder="Description" name="description" cols="30" rows="5">{{ $template->description }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('message') ? 'has-error has-feedback' : '' }}">
                                    <label>Message</label>
                                    <textarea class="form-control" placeholder="Message" name="message" cols="30" rows="5">{{ $template->message }}</textarea>
                        ...
                        <button type="submit" class="btn btn-primary btn-fill">Update post template</button>
